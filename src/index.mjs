...
const PRODUCT = {
  "repo": "okta-access-drift-ledger",
  "vendor": "Okta",
  "title": "access drift ledger",
  "domain": "IAM / Security",
  "audience": "CISOs, identity owners, platform leaders, and diligence teams",
  "problem": "SaaS identity estates grow faster than ownership, MFA posture, app retirement, and access-review evidence can stay aligned.",
  "workflow": "The product turns app ownership, privileged group drift, stale access, MFA gaps, and remediation queues into one board-ready identity-control lane.",
  "business": "Leaders can see which identity controls reduce breach exposure, license waste, and audit scramble before the next access-review cycle.",
  "technical": "Synthetic fixture data is scored deterministically by a Node CLI and published as a static evidence surface with no live tenant data.",
  "integration": "Okta apps, groups, lifecycle events, MFA policies, and review packets.",
  "keywords": [
    "Okta",
    "identity governance",
    "access review",
